...
A linha de comando do Windows (CMD) pode ser uma ferramenta poderosa para programadores, permitindo automação, gerenciamento de arquivos e execução de scripts. Alguns dos principais usos são:
...
Precisamos da linha de comando para realizar várias tarefas cotidianas de programação. 

Vamos experimentar três:
